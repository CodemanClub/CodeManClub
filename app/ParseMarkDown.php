...
class ParseMarkDown extends Model
{
    /**
     * _whiteList
     *
     ...
     * @var string
     */
    public $_blockHtmlTags = 'p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|address|form|fieldset|iframe|hr|legend|article.css|section|nav|aside|hgroup|header|footer|figcaption|svg|script|noscript';
    /**
     * _specialWhiteList
     *
     * @var mixed
